...
(6, 'SPTech Solutions', '04273891000133'),-- ID 6
(7, 'DeltaTech', '77014562000190'); -- ID 7
...
('Estacao 01-E6', 'PC-E6-001', 'HP ProDesk 400', 'C8:CB:9E:5A:5D:A6', 'Windows', 'Online', 6, '192.168.1.101', 1),
('Estacao 02-E6', 'PC-E6-002', 'HP ProDesk 400', '00:1A:2B:3C:4D:52', 'Windows', 'Online', 6, '192.168.1.102', 1),
('Estacao 03-E6', 'PC-E6-003','Dell OptiPlex 3050', '00:1A:2B:3C:4D:53', 'Windows', 'Online', 6, '192.168.1.103', 1),
('Estacao 04-E6', 'PC-E6-004', 'Dell OptiPlex 3050', '00:1A:2B:3C:4D:54', 'Linux', 'Online', 6, '192.168.1.104', 1),
('Estacao 05-E6', 'PC-E6-005', 'Lenovo ThinkCentre M720', '00:1A:2B:3C:4D:55', 'Windows', 'Online', 6, '192.168.1.105', 1),
('Estacao 06-E6', 'PC-E6-006', 'Lenovo ThinkCentre M720', '00:1A:2B:3C:4D:56', 'Linux', 'Online', 6, '192.168.1.106', 1),
...
-- Máquina 1 (fkMaquina=1): ESPECIFICO (Corrigido o ENUM)
(1, 8, NULL, NULL, 1,'ESPECIFICO', 1),
(2, NULL, 16, NULL, 1,'ESPECIFICO', 1),
(3, NULL, 500, 'SSD', 1,'ESPECIFICO', 1),
(4, NULL, NULL, NULL, 1,'ESPECIFICO', 1),

-- Máquina 2 (fkMaquina=2): ESPECIFICO
(1, 12, NULL, NULL, 2,'ESPECIFICO', 1),
(2, NULL, 32, NULL, 2,'ESPECIFICO', 1),
(3, NULL, 1000, 'HDD', 2,'ESPECIFICO', 1),
(4, NULL, NULL, NULL, 2,'ESPECIFICO', 1),

-- Máquina 3 (fkMaquina=3): ESPECIFICO
(1, 4, NULL, NULL, 3,'ESPECIFICO', 1),
(2, NULL, 8, NULL, 3,'ESPECIFICO', 1),
(3, NULL, 250, 'SSD', 3,'ESPECIFICO', 1),
(4, NULL, NULL, NULL, 3,'ESPECIFICO', 1),

-- Máquina 4 (fkMaquina=4): ESPECIFICO
(1, 8, NULL, NULL, 4,'ESPECIFICO', 1),
(2, NULL, 16, NULL, 4,'ESPECIFICO', 1),
(3, NULL, 500, 'SSD', 4,'ESPECIFICO', 1),
(4, NULL, NULL, NULL, 4,'ESPECIFICO', 1),
...
(1, 6, 1, 78, 'ATENCAO','ESPECIFICO', 1),
(1, 6, 1, 83, 'ALERTA','ESPECIFICO', 1),
(1, 6, 1, 88, 'CRITICO','ESPECIFICO', 1),
-- RAM_M1 (Tipo 2 - Componente 2)
(2, 6, 2, 85, 'ATENCAO','ESPECIFICO', 1),
(2, 6, 2, 90, 'ALERTA','ESPECIFICO', 1),
(2, 6, 2, 95, 'CRITICO','ESPECIFICO', 1),
-- DISCO_M1 (Tipo 3 - Componente 3)
(3, 6, 3, 70, 'ATENCAO','ESPECIFICO', 1),
(3, 6, 3, 75, 'ALERTA','ESPECIFICO', 1),
(3, 6, 3, 80, 'CRITICO','ESPECIFICO', 1),
-- REDE_M1 (Tipo 4 - Componente 4)
(4, 6, 4, 550, 'ATENCAO','ESPECIFICO', 1),
(4, 6, 4, 650, 'ALERTA','ESPECIFICO', 1),
(4, 6, 4, 750, 'CRITICO','ESPECIFICO', 1),

-- CPU_M5 (Tipo 1 - Componente 17)
(1, 6, 17, 75, 'ATENCAO','ESPECIFICO', 1),
(1, 6, 17, 80, 'ALERTA','ESPECIFICO', 1),
(1, 6, 17, 85, 'CRITICO','ESPECIFICO', 1),
-- RAM_M5 (Tipo 2 - Componente 18)
(2, 6, 18, 65, 'ATENCAO','ESPECIFICO', 1),
(2, 6, 18, 70, 'ALERTA','ESPECIFICO', 1),
(2, 6, 18, 75, 'CRITICO','ESPECIFICO', 1),
-- DISCO_M5 (Tipo 3 - Componente 19)
(3, 6, 19, 80, 'ATENCAO','ESPECIFICO', 1),
(3, 6, 19, 85, 'ALERTA','ESPECIFICO', 1),
(3, 6, 19, 90, 'CRITICO','ESPECIFICO', 1),
-- REDE_M5 (Tipo 4 - Componente 20)
(4, 6, 20, 700, 'ATENCAO','ESPECIFICO', 1),
(4, 6, 20, 800, 'ALERTA','ESPECIFICO', 1),
(4, 6, 20, 900, 'CRITICO','ESPECIFICO', 1);
...
( 'CPU Acima do Limite Padrão E6', 'ATENCAO', 6, 21),
( 'Disco Acima do Limite Padrão E6', 'ATENCAO', 7, 23),
( 'CPU Acima do Limite Oberon', 'CRITICO', 9, 3),
( 'RAM Acima do Limite Oberon', 'ATENCAO', 10, 4),
( 'Disco Acima do Limite Oberon', 'ATENCAO', 11, 7),
...
( 'RAM Acima do Limite Oberon', 'ATENCAO', 30, 4),
